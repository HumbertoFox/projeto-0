        ...
        <header class="header">
            <nav class="indexnavmenu">
                ...
                <ul class="ulmenu">
                    ...
                    <li class="limenu">
                        <a href="editar-doacao.html" title="Editar Doação" target="menuprincipal">
                            <img class="icon-li" src="./src/images/doacao.png" alt="Icon Editar Doação">
                            <span class="text-li">Editar Doação</span>
                        </a>
                    </li>
                    <li class="limenu">
                        <a href="editar-doador.html" title="Editar Doador" target="menuprincipal">
                    ...
                    <li class="limenu">
                        <a href="confirmar-coleta.html" title="Confirmar Coleta" target="menuprincipal">
                            <img class="icon-li" src="./src/images/confirmar.png" alt="Icon Confirmar Coleta">
                            <span class="text-li">Confirmar Coleta</span>
                        </a>
                    </li>
                    <li class="limenu">
                        <a href="gerar-relatorio.html" title="Relatório" target="menuprincipal">
